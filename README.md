...
> This project is forked from [lqqyt2423/go-mitmproxy](https://github.com/lqqyt2423/go-mitmproxy).
...
```bash
go install github.com/denisvmedia/go-mitmproxy/cmd/go-mitmproxy@latest
```
